...
__name5(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React7.forwardRef(
  ...
  __name6(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React7.forwardRef(__name6(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name6(getDirectionAwareKey, "getDirectionAwareKey");
...
__name6(getFocusIntent, "getFocusIntent");
...
var Menu = __name7((props) => {
  ...
  const direction = useDirection(dir);
  React17.useEffect(() => {
    const handleKeyDown = __name7(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name7(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React17.useEffect(() => {
    ...
    const handleBlur = __name7(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React17.forwardRef(
  __name7(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React17.forwardRef(
  __name7(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React17.forwardRef(
  // blank line to reduce diff noise
  __name7(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
...
var MenuRootContentNonModal = React17.forwardRef(__name7(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  return (0, import_jsx_runtime6.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React17.forwardRef(
  // blank line to reduce diff noise
  __name7(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name7((key) => {
      var _a2, _b;
...
var MenuGroup = React17.forwardRef(
  __name7(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React17.forwardRef(
  __name7(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React17.forwardRef(
  // blank line to reduce diff noise
  __name7(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React17.forwardRef(
  __name7(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React17.forwardRef(
  // blank line to reduce diff noise
  __name7(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name7(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React17.forwardRef(
  __name7(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React17.forwardRef(
  __name7(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React17.forwardRef(
  // blank line to reduce diff noise
  __name7(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React17.forwardRef(
  __name7(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React17.forwardRef(
  __name7(function MenuArrow2(props, forwardedRef) {
...
var MenuSubTrigger = React17.forwardRef(
  __name7(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React17.forwardRef(
  __name7(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
...
__name7(getOpenState, "getOpenState");
function isIndeterminate(checked) {
  return checked === "indeterminate";
}
__name7(isIndeterminate, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name7(getCheckedState, "getCheckedState");
...
__name7(focusFirst3, "focusFirst");
function wrapArray2(array, startIndex) {
  return array.map((_, index) => array[(startIndex + index) % array.length]);
}
__name7(wrapArray2, "wrapArray");
...
__name7(getNextMatch, "getNextMatch");
...
__name7(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name7(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name7(whenMouse, "whenMouse");
var Root3 = Menu;
...
var DropdownMenu = __name8((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name8((props) => {
...
var DropdownMenuContent = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime7.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React18.forwardRef(__name8(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React18.forwardRef(__name8(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React18.forwardRef(__name8(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React18.forwardRef(__name8(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React18.forwardRef(__name8(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime7.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name8((props) => {
...
var DropdownMenuSubTrigger = React18.forwardRef(__name8(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React18.forwardRef(__name8(function DropdownMenuSubContent2(props, forwardedRef) {
